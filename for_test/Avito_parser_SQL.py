...
class InformationFromAds(Base):
    __tablename__ = 'Lash small towls'
...
zapros = ''
engine = create_engine('sqlite:///for_beauty_market Бровисты и лэшмейкеры' + zapros + '.db')
...
def main():
    zapros = 'ресницы'
    region = 'chechenskaya_respublika' #добавить потом, чтобы в БД сохранялся этот параметр как столбец.
